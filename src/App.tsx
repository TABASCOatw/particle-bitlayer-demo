...
const App = () => {
  ...
  const executeTxBtc = async () => {
    ...
    notification.success({
      ...
      description: (
        <div>
          Transaction Hash: <a href={`https://testnet-scan.bitlayer.org/en-us/tx/${hash}`} target="_blank" rel="noopener noreferrer">{hash}</a>
        </div>
      )
    });
  };
  ...
  return (
    <div className="App">
      <div className="logo-section">
        ...
        <img src="https://i.imgur.com/lE3kTad.png" alt="Logo 2" className="logo logo-big-b2" />
      </div>
      {!evmAccount ? (
